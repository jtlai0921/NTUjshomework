...
function changeTxt() {
    if (this.id == "small1") {
        boxMsg.innerHTML = "<a href='https://jtlai0921.github.io/NTUjshomework/layout.html'>利用nuvoTon NANO130KE3BN單晶片MCU微處理器在Keil C的環境下編譯，將大頭照和QR code和設計文字或動畫寫入MCU，由TFT螢幕顯示</a>"
    }
    if (this.id == "small2") {
